...
# Cron task / Process
Precomputed data are build by another process. This process will call the Geem daemon and compute blocks into chunks of blocks to reduce network latency.
...
```
* * * * * $user cd /var/www/domain.com/api && export generate=true && php blockchain.php
```
